      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Conectamos a los dueños de mascotas con veterinarios, peluquerías y
            paseadores confiables en Villa del Rosario
          </p>
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
            <div className="flex gap-2">
              ...
              <Button
                type="submit"
                className="px-6 shadow-primary hover:shadow-primary/50 transition-shadow"
              >
                Buscar
              </Button>
            </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredServices.map((service) => (
              <Card
                key={service.id}
                className="hover:shadow-lg transition-all hover:scale-[1.02] border-primary/10 group"
              >
                <CardHeader>
                  <div className="flex items-start justify-between mb-2">
                    ...
                    >
                      {service.type === "veterinario"
                        ? "Veterinario"
                        : service.type === "peluqueria"
                        ? "Peluquería"
                        : service.type === "paseador"
                        ? "Paseador"
                        : service.type === "guarderia"
                        ? "Guardería"
                        : "Adiestramiento"}
                    </Badge>
            ...
            <Card className="border-secondary/20 hover:border-secondary/40 transition-colors hover:shadow-accent/10 group">
              ...
              <CardContent>
                <Link to="/servicios?peluqueria">
                  <Button
                    variant="outline"
                    className="w-full border-secondary/20 hover:border-secondary"
                  >
                    Ver Peluquerías
                  </Button>
                </Link>
